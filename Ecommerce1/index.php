...
<!--                   -->
                ...
                <div class="row">
                    <div class="col-md-6">
                         <p>Some text..</p>
                           <img src="IMG/img.jpg" class="img-responsive" style="width:50%" alt="Image">           
                        .col-md-6</div>
                    <div class="col-md-6"> 
                          <p>Some text..</p>
                          <img src="IMG/img.jpg" class="img-responsive" style="width:50%" alt="Image">
        ...
        <div class="container-fluid bg-3 text-center">    
            ...
            <div class="row">   
                ...
                <div class="col-md-8"> 
                      <p>Some text..</p>
                      <img src="https://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:50%" alt="Image">
                    .col-md-8
                </div>
                <div class="col-md-4">
                      <p>Some text..</p>
                      <img class="superior" src="https://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:100%" alt="Image">
                      .col-md-4
                </div>
     ...
     <br>
        ...
        <div class="row">
            <div class="col-sm-3">
                <label type="" class="btn btn-default">Normal</label>
