    ...
    <body>
       <nav class="navbar navbar-inverse">
        			...
        			<label for="select2-button-addons-single-input-group" class="control-label"></label>
	        			<div class="input-group">
		         			<div class="input-group-btn">
                                                    <input type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" id="datosmenu">
						       <!--<img src="imgweb/.png" width="30px" height="30px">--><!--<span class="caret"></span>-->
							<ul class="dropdown-menu" id="menus">
                                                            <li class="click" data-toggle="modal" data-target=".bd-example-modal-lg"><div id="1"><img src="imgweb/"><a  href="#">Categoria</a></div></li><br>
                                                            <li class="click" data-toggle="modal" data-target=".bd-example-modal-lg"><div id="2"><img src="imgweb/"><a  href="#">Accesorioa</a></div></li><br>
						            <li class="click" data-toggle="modal" data-target=".bd-example-modal-lg"><div id="3"><img src="imgweb/"><a  href="#">Almacenamiento</a></div></li><br>
  						            <li class="click" data-toggle="modal" data-target=".bd-example-modal-lg"><div id="4"><img src="imgweb/"><a  href="#">Audio y video</a></div></li><br>
                                                            <li class="click" data-toggle="modal" data-target=".bd-example-modal-lg"><div id="5"><img src="imgweb/"><a  href="#">computadoras</a></div></li><br>
							</ul>
						</div> 
                                        </div>                          
                                        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4" style="background: #080808">
                                                            <h6>Accesorios</h6>
                                                            <a id="Categorias" href="#">---------</a>
                                                            <a id="Categorias" href="#">---------</a>
                                                            <a id="Categorias" href="#">---------</a>
                                                        </div><br>
                                                        ...
                                                        <div class="col-md-4" style="background: wheat">
                                                            <h6>Accesorios</h6>
                                                            <a id="Categorias" href="#">--------</a>
                                                            <a id="Categorias" href="#">--------</a>
                                                            <a id="Categorias" href="#">--------</a>
                                                        </div>
                                                        <div class="col-md-4" style="background: grey">
                                                            <h6>Accesorios</h6>
                                                            <a id="Categorias" href="#">Categoria</a>
                                                            <a id="Categorias" href="#">Categoria</a>
                                                            <a id="Categorias" href="#">Categoria</a>
                                                        </div>
                                                        <div class="col-md-4 col-md-offset-4" style="background: yellow">
        ...
        <div class="container-fluid bg-3 text-center">
            ...
            <div class="row">
                <div class="col-md-8"> 
                    <img id="superior1" src="IMG/fondo.jpg" class="img-responsive" style="width: 100%"  alt="Image" id="imgizquierdagroup">
                    <!--.col-md-8-->
                    </div>
                
                    <div class="col-md-4">
                       <img id="superior2" src="IMG/fondo.jpg" class="img-responsive" style="width: 100%" alt="Image" id="imgderechagroup">
                      <!--.col-md-4-->
                    </div>    
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                     <p></p>
                     <img src="IMG/fondo.jpg" class="img-responsive" style="width:100%" alt="Image" id="imag_izqui_Centro_group1">
                    </div>
                    
                    <div class="col-md-4">
                    <p></p>
                      <img src="IMG/fondo.jpg" class="img-responsive" style="width:100%" alt="Image" id="img_cen_Centro_group1"> 
                        <!--.col-md-4-->
                    </div>
                    
                    <div class="col-md-4">  
                        <p></p>
                         <img src="IMG/fondo.jpg" class="img-responsive" style="width:100%" alt="Image" id="img_dere_Centro_group1">
                        <!--.col-md-4-->
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6"> 
                        <img id="inferior1" src="IMG/fondo.jpg" class="img-responsive" style="width: 100%"  alt="Image" id="img_izqui_infe_group2">
                     <!--.col-md-8-->
                    </div>
                
                    <div class="col-md-6">
                       <img id="inferior2" src="IMG/fondo.jpg" class="img-responsive" style="width: 100%" alt="Image" id="img_dere_infe_group2">
                      <!--.col-md-4-->
                    </div>
                </div>
        </div>
        ...
        <div class="container-fluid bg-3 text-center" id="centrados">    
            ...
            <div class="row">
                <div class="col-md-8">
                       ...
                       <a class="populares" >televisiòn</a>
...
Ahora, si eres súper deportista, en Linio podrás encontrar desde aparatos para ejercicio, ropa deportiva, tenis especializados y ¡claro! Audífonos bluetooth para disfrutar de tu música favorita sin tener que estar al pendiente de nada más. Siempre es importante cuidar tu cuerpo, haciendo ejercicio, peor también con los productos de salud y belleza que te ayudarán a mantenerte saludable por dentro y por fuera.  </p>
    ...
    <footer class="container-fluid text-center">
        ...
        <script src="Libreria_js/jquery-1.7.2.min.js"></script>
        <script src="Libreria_js/Principal.js"></script>
