    ...
    <meta name="description" content="Breve descripcion del sitio, basarse en las busquedas de google">
    <meta name="keywords" content="PALABRAS CLAVE DEL SITIO">
   <!-- Usar en una sola linea, no separar -->
    <script type="text/javascript" src="../../bin/JAlert/jquery-1.4.2.min.js"></script><script type="text/javascript" src="../../bin/JAlert/jquery.alerts.js"></script><script src="../../bin/jquery-3.2.1.min.js"></script>
    <!---------------------------------------->    
<!--Scripts -->
...
<!--    <script src="../../bin/footer.js"></script>-->
   ...
   <!-- <script src="https://apis.google.com/js/platform.js" async defer></script>
    <meta name = "google-signin-cliente_id" content="711967017167-lps98a2h9uss11t02749ct5dg3drn7kv.apps.googleusercontent.com">-->
