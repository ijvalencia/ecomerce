        ...
        $.ajax({
            ...
            success: function (sessionmsj) {
                ...
                //console.log(sessionmsj);
                  ...
                  for(i in sessionmsj){
                    var panel = "<div class='panel-body row'><div class='container-fluid bg-3 text-center'><button class='btn btn-default' id='btncontacto'>01-800-CVA</button><div class='detallesPro'>descripcion</div><div class='Precios'>precio</div><input type='button' id='btncontacto"+i+","+sessionmsj[i]["codigo_fabricante"]+"' class='btndetalles' value='Ver Detalles'><div class='row'><div class='col-sm-2' id='position'><img src='imagen' id='imagen'></div></div></div></div><hr>";
                    var contenido = panel;
                    ...
                    contenido = contenido.replace("precio","$"+sessionmsj[i]["total"]);
