						...
						<div class="lnt-dropdown-mega-menu">
							...
							<div class="lnt-subcategroy-carousel-wrap container-fluid">
								<div id="subcategory-home" class="active">
									...
									<div class="col-md-4">
										<img id="img_navbar" src="../../IMG/fondo.jpg">     
									</div>
								</div>
							</div>
						</div>
				...
				<div class="form-group">
					<div class="input-group">
						<div class="input-group-btn lnt-search-category">
							...
							<input name="categoria" id="entrada_categoria" class="hidden" value="Todo">
						...
						<!--Entrada de busqueda -->
						<input name="busqueda" type="text" class="form-control lnt-search-input" aria-label="Search" placeholder="Buscar" minlength="5" maxlength="20">
					</div>
				</div>
				<!-- boton de busqueda-->
...
<script src="../../modulos/inicio/Principal.js"></script>
