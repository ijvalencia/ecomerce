								...
								<div class="form-bottom">
									<form  onsubmit="return validacion()" method="post" class="registration-form">
										...
										<div class="form-group">
											...
											<input type="password" maxlength="30" name="contra" class="form-contra form-control" id="form-contra">
										</div>
										<h6>Confirmar la contraseña</h6>
										<div class="form-group">
											<label class="sr-only" for="confirmacion">Confirma tu contraseña:</label>
											<input type="password" maxlength="30" name="confirmacion" class="form-confirmacion form-control" id="form-confirmacion">
										</div>
										<div class="col-sm-12">
...
<script src="../../Js/Libreria_js/jquery-1.7.2.min.js"></script>-->
			<script src="../../Js/Libreria_js/Login.js"></script>
