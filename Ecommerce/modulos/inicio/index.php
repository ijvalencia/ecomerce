...
<br><br><br>
    ...
    <div class="jumbotron">
        ...
        <div class="container text-center">
				...
				<div id="Carousel" class="carousel slide">
					<div class="carousel-inner">
						<div class="item active">
							<div class="row">
								<div class="col-md-3"><a href="detalles.php" class="thumbnail" id="sombreado"><img  src="../../imgweb/21000Z0-500x500.jpg" alt="Image" style="max-width:100%;"><hr><p><small>Disco Duro de 1 Tera</small></p></a></div>
								<div class="col-md-3"><a href="#" class="thumbnail" id="sombreado"><img src="../../imgweb/21000Z1-500x500.jpg" alt="Image" style="max-width:100%;"><p><hr><small>Disco Duro de 2 Tera</small></p></a></div>
			...
			<div class="item">
				<div class="row">
					<div class="col-md-3"><a href="#" class="thumbnail" id="sombreado"><img src="../../imgweb/usb.png" alt="Image" style="max-width:100%;"><p><small></small></p></a></div>
					<div class="col-md-3"><a href="#" class="thumbnail" id="sombreado"><img src="../../imgweb/usb1.jpg" alt="Image" style="max-width:100%;"><p><small></small></p></a></div>
					<div class="col-md-3"><a href="#" class="thumbnail" id="sombreado"><img src="../../imgweb/tera.png" alt="Image" style="max-width:100%;"><p><small></small></p> </a></div>
					<div class="col-md-3"><a href="#" class="thumbnail" id="sombreado"><img src="../../imgweb/disco duro.png" alt="Image" style="max-width:100%;"><p><small></small></p></a></div>
				</div>
			</div>
			<div class="item">
				<div class="row">
					...
					<div class="col-md-3"><a href="#" class="thumbnail" id="sombreado"><img src="../../imgweb/" alt="Image" style="max-width:100%;"><p><small>Este contenido de texto se verá más pequeño y puede ser utilizado por ejemplo para "la letra pequeña" de la página</small></p></a></div>
				</div>
			</div>
		</div>
