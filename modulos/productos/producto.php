...
<html>
	...
	<body>
		...
		<table border='0' width='65%'>
			<tr>
				<td colspan="7"><center><font size="5"><b><?php echo $consulta['nombre']; ?></b></font></center></td>
			</tr>
			<tr>
				<td><font size='2'>Marca: <?php echo $consulta['fabricante']; ?></font></td>
				<td><font size='2'>Mas productos <a href=''><?php echo $consulta['fabricante']; ?></a></font></td>
				<td><font size='2'><?php echo $consulta['existencias']; ?> disponibles</font></td>
				<td width='5%'><font size='2'><center><?php $calificacion=$con->calificacion($id);?>
					<?php echo "<P style='COLOR: white; BACKGROUND-COLOR: Green'> ".$calificacion."</p>";?></center></font></td>
				<td><font size='2'><?php $con->contarCalificantes($id); echo " Valoraciones"; ?></font></td>
				<td><font size='2'><a href="">Rese&ntilde;as</a></font></td>
				<td width='40%'></td>        
			</tr>
		</table>
...
-->     
		...
		<table border="0" width="65%">
			<tr><td></td><td><b><center><font size="5">Recomendaciones<br></font></center></b></td><td></td></tr>
			<tr><td width="10%"></td><td>
				<iframe frameborder="0" src="C_Recomendados.php?objeto=<?php echo $consulta['categoria']; ?>" width="100%" height="300"></iframe>  
				</td><td width="10%"></td></tr> 
			
			<tr><td></td><td><b><center><font size="5">Mas Vendido<br></font></center></b></td><td></td></tr>
			<tr><td width="10%"></td><td>
